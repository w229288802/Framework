...
var columns=[
 	        ...
 	        {field:'operation',name:'操作',align:'center',formatter:function(val,index,row){
 	        	return '<a class="add" target="dialog" href="${actionPath}!edit.action?id='+row.id+'"  mask="true"><span>修改</span></a>';
 	        }}
];

$(document).ready(function(){
	initTable("${actionPath}","sys_user_table","${pageNum}","${numPerPage}");
});
</script>
<div class="pageContent">
	...
	<table id="sys_user_table" width="100%" >
	</table>
